...
namespace Carlos
{
    public class MyCustomListAdapter : BaseAdapter<Restaurant>
    {
        List<Restaurant> rests;

        public MyCustomListAdapter(List<Restaurant> rests)
        {
            this.rests = rests;
        }
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (view == null)
            {
                ...
                view.Tag = new ViewHolder() { Name = Name_ , NameSub = NameSub_,AddressOne = AddressOne_ , AddressTwo = AddressTwo_ , AddressThr = AddressThr_ };
            }
